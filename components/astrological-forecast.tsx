  ...
  return (
    ...
    >
      ...
      <div className="self-stretch flex flex-col items-start justify-start py-0 px-3 gap-[13px]">
        <div className="self-stretch relative font-semibold mq450:text-base">{prop}</div>
        <div className="self-stretch relative font-ibm-plex-sans text-dimgray-100 mq450:text-base">{prop1}</div>
      </div>
      <button
