...
const BlockRow3: NextPage<BlockRow3Type> = ({ className = "", prop, vIII, prop1, vIIIFontFamily }) => {
  ...
  return (
    ...
    >
      <img className="h-[30px] w-[71px] relative object-cover" alt="" src="/image-15@2x.png" />
